...
public class PublicationsControllers {
    ...
    public ResponseEntity<Publication> getPublicationByID(@PathVariable(value="id") int id) throws ResourceNotFoundException {
    ...
    public ResponseEntity<ResponseMessage> updatePublication( @PathVariable(value = "id") int id, @RequestBody Publication publication) throws ResourceNotFoundException {
    ...
    public ResponseEntity<ResponseMessage> deletePublication(@PathVariable(value="id") int id) throws ResourceNotFoundException {
